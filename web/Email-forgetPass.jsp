                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="login_part_form2">
                            ...
                            <div class="alert alert-danger" role="alert">
                                Nhap Email de bon tao gui code xac thuc
                            </div>
                            <form class="row contact_form" action="send-code" method="post" novalidate="novalidate"style="margin-left: 1px;">                
                                <div class="payment_item" style="margin:20px 0">
                                    <input type="text" placeholder="Email" name="email" style="padding: 15px;margin-right: 15px;"/>
                                </div>
