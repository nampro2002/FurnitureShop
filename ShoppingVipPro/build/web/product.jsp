<%-- 
    Document   : category
    Created on : Jul 4, 2022, 8:44:33 PM
    Author     : Admin
--%>
...
<html lang="zxx">
                                ...
                                <div class="widgets_inner">
                                    <ul class="list">
                                        <c:forEach items="${listcate}" var="c">
                                            <li>
                                                <a href="filter-category?categoryId=${c.id}">${c.name}</a>
                                ...
                                <div class="product_top_bar d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="single_product_menu d-flex">
                                        ...
                                        <select id="filter-prod">
                                            <option data-display="None" value = "0">None</option>
                            ...
                            <div class="pageination ">
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center">
                                        <li class="page-item">
                                            <a class="page-link" href="product?page=${page-1}" aria-label="Previous">
                                                <i class="fa-solid fa-angle-left"></i>
                                            </a>
                                        </li>
                                        <c:forEach begin ="1" end="${totalPage}" var = "i">
                                            <li class="page-item "><a class="page-link ${i==page?"li-on":""}" href="product?page=${i}">${i}</a></li> 
                                            <li class="page-item">
                                            </c:forEach>
                                            <a class="page-link" href="product?page=${page+1}" aria-label="Next">
    ...
    <!--::footer_part end::-->
    <script>
        function addToCartAsync(productId, accountId) {
