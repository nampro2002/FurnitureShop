<%-- 
    Document   : login
    Created on : Jul 6, 2022, 3:02:25 PM
    Author     : Admin
--%>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_form">
                        <div class="login_part_form_iner">
                            ...
                            <form class="row contact_form" action="new-pass" method="post" novalidate="novalidate">                
                                <div class="col-md-12 form-group p_star">
                                    <input type="password" class="new-pass" id="password" name="password"  placeholder="Password">
                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <input type="password" class="form-control" id="password" name="repassword"  placeholder="Confim Password">
                                </div>
