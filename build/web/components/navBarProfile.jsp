            ...
            <div class="col-lg-12">
                ...
                <c:choose>
                    <c:when test="${sessionScope.account != null}">
                        <div class="log-sgin">
                            <a href="#" class="genric-btn info ">USER</a>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">     
                        <div class="" style="margin: 10px;">
                            <a href="profile.jsp" class="genric-btn info">Profile</a>
                            <a href="profileOrder.jsp" class="genric-btn info">Order</a>
                            <a href="profileOrderHistory.jsp" class="genric-btn info">OrderHistory</a>
                            <a href="adminUser.jsp" class="genric-btn info">User</a>
                            <a href="adminProduct.jsp" class="genric-btn info">Product</a>
                        </div>
                    </div>
                </nav>
